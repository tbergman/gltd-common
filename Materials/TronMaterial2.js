...
export default function TronMaterial2({ materialRef, side, color }) {
...
// export default function TronMaterial2({ materialRef, color, ...props }) {
// 	color = color || 0xffffff;
// 	materialRef = materialRef ? materialRef : useRef().current;
// 	const { clock, size } = useThree();
// 	const uniforms = useRef();
...
// 		ref={materialRef}
// 		uniforms={uniforms.current}
// 		side={props.side ? props.side : THREE.FrontSide}
// 		vertexShader={simpleVertex}
// 		fragmentShader={tronFragmentShader}
// 	/>;
// }
